...
func (c *sumClient) Add(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumReponse, error) {
	out := new(SumReponse)
...
type SumServer interface {
	Add(context.Context, *SumRequest) (*SumReponse, error)
...
func (UnimplementedSumServer) Add(context.Context, *SumRequest) (*SumReponse, error) {
